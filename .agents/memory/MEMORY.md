...
- [Review video upload latency](review-video-upload-latency.md) — background Telegram work cannot shorten a multipart request; the browser must finish uploading the body first.