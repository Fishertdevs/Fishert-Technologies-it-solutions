...
export default function About() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // ── Initial hidden states for text only ─────────────────
      ...
      // Title lines cascade up with de-skew on scroll
      tl.to(
        ".about-line-inner",
        { yPercent: 0, skewX: 0, stagger: 0.09, duration: 0.55, ease: "none" },
        0,
      );

      // CTA buttons appear after lines
  ...
  return (
    <section id="inicio" className="about-section" ref={sectionRef}>
      <div className="about-content">
        ...
        <div className="about-char-col">
          <div className="about-char-wrap">
            <img
              src={`${base}hero-char.png`}
              alt=""
