...
function CookieIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
      ...
      {/* Chips */}
      <circle cx="8.5" cy="11.5" r="1.5" fill="rgba(10,10,10,0.6)" />
      <circle cx="12" cy="15" r="1" fill="rgba(10,10,10,0.6)" />
      <circle cx="15" cy="11" r="1" fill="rgba(10,10,10,0.6)" />
      <circle cx="10" cy="8" r="1" fill="rgba(10,10,10,0.6)" />
    </svg>
  );
}
