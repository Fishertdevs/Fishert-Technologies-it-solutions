...
const WA_MSG    = encodeURIComponent("Hola Fishert Studio, tengo un proyecto en mente.");
...
const content = {
  es: {
    ...
    hours: "Lun – Vie · 9:00 – 18:00 (GMT-5)",
    info: [
      ...
      { icon: "whatsapp", label: "WhatsApp",            value: PHONE_DISPLAY,               href: `https://wa.me/${WA_NUMBER}?text=${WA_MSG}` },
    ],
    steps: [
      {
        n: "01",
        title: "Cuéntanos tu proyecto",
        desc:  "Envíanos un mensaje describiendo brevemente tu idea. Respondemos en menos de 24 h.",
      },
      {
        n: "02",
        title: "Agendamos una llamada",
        desc:  "Te proponemos un horario de 30 minutos para conocernos y alinear el alcance.",
      },
      {
        n: "03",
        title: "Recibes la confirmación",
        desc:  "La cita llega directo a tu WhatsApp. Sin formularios, sin fricciones.",
      },
    ],
    cta: "Agendar",
  },
  en: {
    ...
    hours: "Mon – Fri · 9:00 – 18:00 (GMT-5)",
    info: [
    ...
    steps: [
      {
        ...
        desc:  "Send us a brief message on WhatsApp describing your idea. We reply within 24 h.",
      },
      {
        n: "02",
        title: "We schedule a call",
        desc:  "We propose a 30-minute slot to get to know each other and align on scope.",
      },
      {
        n: "03",
        title: "Receive your confirmation",
        desc:  "The appointment lands straight in your WhatsApp. No forms, no friction.",
      },
    ],
    cta: "Book now",
  },
...
export default function Contacto() {
  ...
  return (
    <section id="contacto" className="contacto-section">
      ...
      {/* ── Top wave — fill matches the section above (black) ── */}
                ...
                <div className="cslider-track" style={{ transform: `translateX(${slide * -50}%)` }}>
                  ...
                  <div className="cslider-slide">
                    <div className="cslide-contact-header">
                      ...
                      <p className="contacto-info-hours">
                    ...
                    <div className="contacto-social-row">
                      ...
                      <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                        className="contacto-social-btn" aria-label="Instagram">
                      ...
                      <a href="https://github.com" target="_blank" rel="noopener noreferrer"
                        className="contacto-social-btn" aria-label="GitHub">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <a href={`https://wa.me/${WA_NUMBER}`} target="_blank" rel="noopener noreferrer"
                        className="contacto-social-btn" aria-label="WhatsApp">
                  ...
                  <div className="cslider-slide cslider-slide--booking">
                    <p className="cslider-booking-intro">
                      Agenda una llamada de 30 min y hablemos de tu proyecto.
                    </p>
