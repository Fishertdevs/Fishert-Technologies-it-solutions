...
export default function Footer() {
  ...
  return (
    <footer id="contacto" className="footer-section">
      {/* Top wave — white to match section above */}
      <svg
      ...
      <div className="footer-inner">
        ...
        <div className="footer-icons">
          {/* GitHub */}
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="footer-icon-btn" aria-label="GitHub">
          ...
          {/* Instagram */}
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="footer-icon-btn" aria-label="Instagram">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* WhatsApp */}
          <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="footer-icon-btn" aria-label="WhatsApp">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <nav className="footer-links">
          {t.links.map((link, i) => (
            <span key={link} className="footer-link-group">
