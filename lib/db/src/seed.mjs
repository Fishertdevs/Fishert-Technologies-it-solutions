...
const teamMembers = [
  [
    "Harry Fishert",
    "Fundador · Líder de desarrollo y diseño",
    "Founder · Development & Design Lead",
    "Transformo ideas ambiciosas en productos digitales claros, combinando estrategia, desarrollo y diseño para que cada decisión tenga propósito.",
    "I turn ambitious ideas into clear digital products, combining strategy, development, and design so every decision has purpose.",
    0,
  ],
  [
    "David Moya",
    "QA Tester",
    "QA Tester",
    "Pongo cada experiencia a prueba para encontrar los detalles que importan y asegurar productos confiables, fluidos y listos para crecer.",
    "I test every experience to find the details that matter and make sure products are reliable, smooth, and ready to grow.",
    1,
  ],
  [
    "Samuel Tellez",
    "Gestión interna",
    "Internal Operations",
    "Organizo los procesos internos que mantienen al estudio enfocado, coordinado y preparado para convertir buenas ideas en resultados.",
    "I organize the internal processes that keep the studio focused, coordinated, and ready to turn good ideas into results.",
    2,
  ],
];
...
try {
  ...
  for (const [name, roleEs, roleEn, bioEs, bioEn, sortOrder] of teamMembers) {
    await client.query(
      `INSERT INTO team_members (name, role_es, role_en, bio_es, bio_en, sort_order)
       VALUES ($1, $2, $3, $4, $5, $6)
       ON CONFLICT DO NOTHING`,
      [name, roleEs, roleEn, bioEs, bioEn, sortOrder],
    );
  }
